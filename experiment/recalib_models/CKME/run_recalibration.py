...
parser = argparse.ArgumentParser(
    description="Runs recalibration model CKME + KDO on the given split.")
...
# Set up logger
logger = logging.getLogger("RecalibrationModel_CKMEKDO_runner")
...
SCRIPT_JL_PATH = os.path.join(SCRIPT_DIR, "script.jl")



result = subprocess.run([
    "julia", "--project=../../", SCRIPT_JL_PATH, 
